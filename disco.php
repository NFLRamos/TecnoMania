    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        <div class="jumbotron jumbotron-fluid mt-4">
          <div class="container">
            <h1 class="text-center"style="font-weight:bold;">Disco Rigido</h1>
            <p class="lead" style="text-align: justify;">O disco rígido é um componente de hardware do computador. Sua utilidade é o armazenamento de dados, isto significa que quando algum arquivo é armazenado, ele não se perde com o desligamento da máquina</p>
          </div>
        </div>
        ...
        <?php
        $sql = "SELECT * FROM produtos where categoria = 'disco'";
