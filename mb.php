    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        <div class="jumbotron jumbotron-fluid mt-4">
          <div class="container">
            <h1 class="text-center "style="font-weight:bold;">MotherBoards</h1>
            <p class="lead" style="text-align: justify;">A MotherBoard é uma placa de circuito impresso que permite interligar todos os componentes de um computador. Nesse sentido, conta com um programa (software) básico conhecido como BIOS, que lhe permite preencher as suas funções.</p>
          </div>
        </div>
        ...
        <?php
        $sql = "SELECT * FROM produtos where categoria = 'motherboard'";
