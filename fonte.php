    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        <div class="jumbotron jumbotron-fluid mt-4">
          <div class="container">
            <h1 class="text-center"style="font-weight:bold;">Fonte Alimentação</h1>
            <p class="lead" style="text-align: justify;">A função da fonte é transformar a corrente alternada da tomada em corrente contínua (AC) já nas tensões corretas, usadas pelos componentes. Ela serve também como uma última linha de defesa contra picos de tensão e instabilidade na corrente.</p>
          </div>
        </div>
        ...
        <?php
        $sql = "SELECT * FROM produtos where categoria = 'fonte'";
