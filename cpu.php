...
<body>
  ...
  <div class="container mt-5">
    ...
    <div class="row">
      ...
      <div class="col-lg-9" id="iderino">
        <div class="jumbotron jumbotron-fluid mt-4">
          <div class="container">
            <h1 class="text-center" style="font-weight:bold;">CPU</h1>
            <p class="lead" style="text-align: justify;">O processador é responsável por calcular e realizar tarefas determinadas pelo usuário e é considerado o cérebro do PC.</p>
          </div>
        </div>
        ...
        <?php
        $sql = "SELECT * FROM produtos where categoria = 'cpu'";
