    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          ...
          <a href="ram.php" class="list-group-item hoverino" style="color:black; font-weight: bold;">Memórias RAM</a>
          <a href="disco.php" class="list-group-item hoverino" style="color:black; font-weight: bold;">Discos Rigidos</a>
          <a href="fonte.php" class="list-group-item hoverino" style="color:black; font-weight: bold;">Fontes Alimentação</a>
          <a href="caixa.php" class="list-group-item hoverino" style="color:black; font-weight: bold;">Caixas Desktop</a>
        </div>
      ...
      <div class="col-lg-9">
        <div class="jumbotron jumbotron-fluid mt-4">
          <div class="container">
            <h1 class="text-center "style="font-weight:bold;">Placa Gráfica</h1>
            <p class="lead" style="text-align: justify;">Qualquer utilizador que tenha certas necessidades básicas e pretende jogar a um videojogo com algum conteúdo em 3D, renderizado ou uso contínuo de qualquer programa de desenho gráfico, é preferível que coloque a sua atenção sobre uma placa gráfica dedicada</p>
          </div>
        </div>
        ...
        <?php
        $sql = "SELECT * FROM produtos where categoria = 'gpu'";
